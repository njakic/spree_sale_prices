...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency 'momentjs-rails', '>= 2.9.0'
  s.add_development_dependency 'bootstrap3-datetimepicker-rails', '~> 4.15.35'
  s.add_runtime_dependency 'slim-rails', '~> 3.0.1'
